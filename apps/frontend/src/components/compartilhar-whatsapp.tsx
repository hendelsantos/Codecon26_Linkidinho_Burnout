...
export function CompartilharWhatsApp() {
  ...
  return (
    <button
      ...
      className="fixed bottom-6 right-4 z-[9997] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_24px_rgba(37,211,102,0.45)] transition-all hover:scale-110 hover:shadow-[0_4px_32px_rgba(37,211,102,0.65)] sm:right-6"
    >
      {/* WhatsApp icon */}
